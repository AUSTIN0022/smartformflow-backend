...
export class EventController {
    ...
    updateEvent = async (req: Request, res: Response, next: NextFunction) => {
        try {
            const userId = req.user!.id;
            const result = await this.eventService.updateEvent(req.params.id!, userId, req.body);
    ...
    findBySlug  = async (req: Request, res: Response, next: NextFunction) => {   
        try {
            ...
            const result = await this.eventService.findbySlug(req.params.slug!);
    ...
    publishEvent =  async (req: Request, res: Response, next: NextFunction) => {   
        try {
            const userId = req.user!.id;
            const result = await this.eventService.publishEvent(req.params.id!, userId);
     ...
     closeEvent =  async (req: Request, res: Response, next: NextFunction) => {   
        try {
            const userId = req.user!.id;
            const result = await this.eventService.closeEvent(req.params.id!, userId);
    ...
    deleteEvent =  async (req: Request, res: Response, next: NextFunction) => {   
        try {
            const userId = req.user!.id;
            const result = await this.eventService.deleteEvent(req.params.id!, userId);
